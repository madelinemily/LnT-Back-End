...
<div class="card mb-4 mt-4">
    <div class="card-header">
        ...
        All Department
        <a href="<?php echo e(url('depart/create')); ?>" class="float-end btn btn-sm btn-success">Add New</a>
    </div>
    <div class="card-body">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel-apps\employeeRecord\resources\views/department/index.blade.php ENDPATH**/ ?>